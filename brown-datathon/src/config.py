...
class Config(argparse.Namespace):
    ...
    def build_parser(self):
        ...
        parser.add_argument('--name', default = 'shake_drop_deepcut')
        ...
        parser.add_argument('--shake_drop', action='store_true', default=True, 
                help='use shake drop')
        ...
        parser.add_argument('--use_deep_cut', action='store_true',default = True,help='use deepcut on mask')
